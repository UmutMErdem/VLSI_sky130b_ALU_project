...
"
spice_ignore=false}
C {devices/code_shown.sym} 450 270 0 0 {name=NGSPICE only_toplevel=true value="
.include /home/ume/Desktop/design3/mag/2x1_mux_pex.spice
...
C {devices/lab_pin.sym} 530 130 3 0 {name=l11 sig_type=std_logic lab=OUT}
...
C {devices/gnd.sym} 640 180 0 0 {name=l16 lab=GND}
C {devices/lab_pin.sym} 640 60 2 0 {name=l17 sig_type=std_logic lab=VDD}
C {inv_with_fo4/fo4_inverter.sym} 680 140 0 0 {name=x2}
C {2x1_mux_with_fo4/2x1_mux.sym} 560 80 0 0 {name=x1}
C {devices/gnd.sym} 750 180 0 0 {name=l15 lab=GND}
