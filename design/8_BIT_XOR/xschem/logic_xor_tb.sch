...
C {devices/lab_pin.sym} 290 30 0 0 {name=l35 sig_type=std_logic lab=A[0:7]}
C {devices/lab_pin.sym} 290 50 0 0 {name=l36 sig_type=std_logic lab=B[0:7]}
C {devices/lab_pin.sym} 420 40 2 0 {name=l37 sig_type=std_logic lab=Y[0:7]}
C {devices/lab_pin.sym} 350 -10 2 0 {name=l38 sig_type=std_logic lab=VDD}
C {devices/gnd.sym} 350 90 0 0 {name=l39 lab=GND}
...
C {logic_xor.sym} 360 40 0 0 {name=x1}
